...
// This class is responsible for connecting to the database and retrieving user credentials for testing purposes.
public class DatabaseConnection {

    // Static variables to store the retrieved email and password from the database, which can be accessed by other test classes
